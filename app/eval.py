...
class llmJudge:
    ...
    def __init__(self, 
                 ...
                 **kwargs):
        """
        Initializes llmJudge as evaluator.
        :param task: The type of task to evaluate, either "retrieval" or "generation".
        :param summarize: The method to summarize evaluation results, either "average" or "best-of-n".
        :param experiment: The name of the experiment for which the evaluation is being performed.
        """
    ...
    def __call__(self, queries:List[str], responses:List[Union[List[str], str]], **kwargs) -> Dict:
        ...
        :param queries: A list of queries to evaluate.
        :param responses: A list of responses, each corresponding to a query in the list of queries.
        :return: A dictionary containing the evaluation results and summary.
        """
